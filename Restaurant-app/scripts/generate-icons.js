...
const logoPath = path.join(__dirname, '../assets/resturant-app-logo.png');
...
async function generateIcons() {
  ...
  const bgSizes = [1024, 512];
  for (const size of bgSizes) {
    await sharp({ create: { width: size, height: size, channels: 4, background: { r: 255, g: 215, b: 0, alpha: 1 } } })
  ...
  // Generate monochrome for Android
