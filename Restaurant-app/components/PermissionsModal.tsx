        ...
        <View style={styles.card}>
          <View style={styles.header}>
            ...
            <Text style={styles.description}>
              Chatori Jeeb Restaurant needs Location and Notification permissions to manage orders, sound alerts, and update delivery statuses.
            </Text>
          </View>
          ...
          <View style={styles.itemsContainer}>
            ...
            <View style={styles.permissionRow}>
              ...
              <View style={{ flex: 1, marginLeft: 14 }}>
                ...
                <Text style={styles.itemSub}>Used for calculating distances for incoming orders and delivery routing.</Text>
              </View>
              <Ionicons
            ...
            <View style={styles.permissionRow}>
              ...
              <View style={{ flex: 1, marginLeft: 14 }}>
                ...
                <Text style={styles.itemSub}>Crucial for receiving order notifications and ring alerts in the background.</Text>
              </View>
              <Ionicons
            ...
            {!hasPrompted ? (
              ...
              <View style={{ width: '100%', gap: 12 }}>
                <Text style={styles.settingsWarning}>
                  Permissions are disabled in settings. Please enable them to receive order ring alerts.
                </Text>
...
const styles = StyleSheet.create({
  ...
  shieldBg: {
    ...
    height: 72,
    borderRadius: 24,
    backgroundColor: 'rgba(212, 175, 55, 0.15)', // Light premium gold hue
    alignItems: 'center',
    justifyContent: 'center',
    marginBottom: 16,
  },
