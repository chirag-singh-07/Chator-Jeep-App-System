        ...
        <View style={styles.card}>
          <View style={styles.header}>
            ...
            <Text style={styles.description}>
              Chatori Jeeb Delivery needs Location and Notification permissions to assign shipments and track your routes during active orders.
            </Text>
          </View>
          ...
          <View style={styles.itemsContainer}>
            ...
            <View style={styles.permissionRow}>
              ...
              <View style={{ flex: 1, marginLeft: 14 }}>
                ...
                <Text style={styles.itemSub}>Used for calculating routes, delivery distances, and tracking your active drops.</Text>
              </View>
              <Ionicons
            ...
            <View style={styles.permissionRow}>
              ...
              <View style={{ flex: 1, marginLeft: 14 }}>
                ...
                <Text style={styles.itemSub}>Receive real-time drop requests, dispatch updates, and support messages.</Text>
              </View>
              <Ionicons
            ...
            {!hasPrompted ? (
              ...
              <View style={{ width: '100%', gap: 12 }}>
                <Text style={styles.settingsWarning}>
                  Permissions are disabled in settings. Please enable them to take delivery tasks.
                </Text>
...
const styles = StyleSheet.create({
  ...
  shieldBg: {
    ...
    height: 72,
    borderRadius: 24,
    backgroundColor: 'rgba(27, 79, 216, 0.15)', // Light royal blue hue
    alignItems: 'center',
    justifyContent: 'center',
    marginBottom: 16,
  },
