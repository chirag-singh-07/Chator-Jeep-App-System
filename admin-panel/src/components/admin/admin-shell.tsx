...
const routeMeta: Record<string, { title: string; subtitle: string }> = {
  "/overview": {
    ...
    subtitle:
      "Track performance, growth, and operational health across the network.",
  },
  "/orders": {
    title: "Orders",
    subtitle:
      "Monitor the full order funnel, filter queues, and jump into order-level details.",
  },
  "/users": {
    title: "Users",
    subtitle:
      "Manage customers, delivery partners, and administrative accounts from one workspace.",
  },
  "/restaurants": {
    title: "Partners Management",
    subtitle:
      "Unified hub for viewing, verifying, and managing all restaurant partners.",
  },
  "/food-items": {
    title: "Food Items",
    subtitle:
      "Manage catalog items, filter by type, and add new menu inventory cleanly.",
  },
  "/categories": {
    title: "Categories",
    subtitle:
      "Control category structure, image quality, and subcategory taxonomy.",
  },
  "/payments": {
    title: "Payments",
    subtitle:
      "Watch settlement health and refund activity with finance-friendly summaries.",
  },
  "/settings": {
    title: "Settings",
    subtitle:
      "Adjust workspace defaults, notifications, and visibility preferences.",
  },
  "/profile": {
    title: "Profile",
    subtitle:
      "View the current admin profile, permissions, and workspace access scope.",
  },
  "/addons": {
    title: "Food Add-ons",
    subtitle:
  ...
  "/analytics/sales": {
    ...
    subtitle:
      "Deep dive into platform sales performance and conversion trends.",
  },
  "/analytics/revenue": {
    title: "Revenue Deepdive",
    subtitle:
      "Track platform earnings, commission splits, and financial health.",
  },
  "/analytics/performance": {
    title: "Performance Metrics",
    subtitle:
      "Analyze kitchen efficiency, delivery SLAs, and customer satisfaction.",
  },
  "/delivery/agents": {
  ...
  "/delivery/tracking": {
    title: "Live Tracking",
    subtitle:
      "Real-time GPS monitoring of active delivery orders on the field.",
  },
  "/marketing/coupons": {
  ...
  "/support/reviews": {
    title: "Order Reviews",
    subtitle: "Monitor customer feedback and quality scores.",
  },
  "/inventory": {
    title: "Inventory Control",
    subtitle: "Global stock management and low-inventory alerts for partners.",
  },
  "/system/logs": {
    title: "Audit Logs",
  ...
  "/staff": {
    ...
    subtitle:
      "Internal team access control, roles, and administrative permissions.",
  },
  "/tax-settings": {
