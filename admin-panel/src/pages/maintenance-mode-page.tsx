...
import { HardHat, Search, Filter, MoreVertical, Layout, Activity, Settings, Bell, Shield, Globe } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Control system availability during updates.</p>
        </div>
        ...
        <CardContent>
           <div className="h-96 rounded-2xl bg-muted/30 flex flex-col items-center justify-center border-2 border-dashed border-muted">
              <div className="h-16 w-16 rounded-3xl bg-primary/5 flex items-center justify-center mb-4">
                 <HardHat className="h-8 w-8 text-primary/40" />
              </div>
              <p className="text-sm font-medium text-muted-foreground">Detailed view for Maintenance Mode is ready for integration</p>
